...
$routes->group('admin', function ($routes) {
    ...
    $routes->get('backups/downloadBackup/(:any)', 'BackupsController::downloadBackup/$1', ['namespace' => 'julio101290\boilerplatebackup\Controllers']);
    
    $routes->get('backups/restore/(:any)', 'BackupsController::restoreBackup/$1', ['namespace' => 'julio101290\boilerplatebackup\Controllers']);
